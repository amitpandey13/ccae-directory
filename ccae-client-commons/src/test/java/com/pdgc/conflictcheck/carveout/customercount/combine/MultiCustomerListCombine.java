...
public class MultiCustomerListCombine extends ConflictCalculationTest {
	
	/**
	 * Proves that no matter how many CustomerLists, it will all combine into
	 * one super carveOut
	 */
	@Test
	public void fourCustomersFourCarveOutsOneMaxTest() {
		// license 1
		...
		carveOuts.add(CustomerCarveOut.builder()
            	...
            	.carveOutType(FoxCarveOutType.CUSTOMERS)
            	.origTerm(exclusivityLicense1.getTerm()) 
            	.carveOutCustomers(Arrays.asList(dummyCustomer4)) 
            	.carveOutImpactType(CarveOutImpactType.EXCEPT_AGAINST) 
            	.carveOutCombineRule(CarveOutCombineRule.OR)
            	.carveOutOrder(3)
            	.carveOutGroupId(1)
